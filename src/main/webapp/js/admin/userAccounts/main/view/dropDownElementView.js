var dropDownElementView = Backbone.View.extend({
    ...
    template: '/blueloop-backend/static/js/admin/userAccounts/main/template/dropDownElementTemplate.ejs',
    ...
    setPermission : function(){
        ...
        var dataAjax = ajaxCall('POST', '/blueloop-backend/administrator/saveUserPermissions/', JSON.stringify(data), 'application/json; charset=utf-8', "json", false);
