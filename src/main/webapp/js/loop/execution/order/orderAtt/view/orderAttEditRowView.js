var orderAttEditRowView = Backbone.View.extend({
    ...
    cancelEditAttach: function(e) {
        ...
        var rowView = new orderAttRowView( { model: e.data.model, tableView:e.data.tableView } );
    ...
    saveDescription: function(context) {
        ...
        var dataReturned = $.ajax({
            ...
            success: function(data, textStatus) {
                ...
                var tableView = new orderAttTableView( { model: context.tableView.model, tableView:context.tableView } );
                context.$el.parents(".sub-row-content").html(tableView.render().$el);
