var forecastInstSubCatRowView = Backbone.View.extend({
    ...
    template: '/blueloop-backend/static/js/loop/forecast/fcstInst/fcstInstEditCat/template/fcstInstSubRow.ejs',
	...
	deleteSubCatInDB: function(e) {
		...
		var dataReturned = $.ajax({
			type: 'POST',
			url: '/blueloop-backend/fcstCategory/deleteSubCatForecast/',
