...
[data]);else{var content="";for(var i in data["owl"])content+=data["owl"][i]["item"];base.$elem.html(content)}base.logIn()}$.getJSON(url,getData)}else base.logIn()},logIn:function(){var base=this;base.baseClass();base.$elem.css({opacity:0});base.checkTouch();base.support3d();base.wrapperWidth=0;base.currentSlide=0;base.userItems=base.$elem.children();base.itemsAmount=base.userItems.length;base.wrapItems();base.owlItems=base.$elem.find(".owl-item");base.owlWrapper=base.$elem.find(".owl-wrapper");base.orignalItems=
base.options.items;base.playDirection="next";base.checkVisible;base.onStartup();base.customEvents()},onStartup:function(){var base=this;base.updateItems();base.calculateAll();base.buildControls();base.updateControls();base.response();base.moveEvents();base.stopOnHover();if(base.options.autoPlay===true)base.options.autoPlay=5E3;base.play();base.$elem.find(".owl-wrapper").css("display","block");if(!base.$elem.is(":visible"))base.watchVisibility();else setTimeout(function(){base.$elem.animate({opacity:1},
200)},10);base.onstartup=false;base.eachMoveUpdate();if(typeof base.options.afterInit==="function")base.options.afterInit.apply(this,[base.$elem])},eachMoveUpdate:function(){var base=this;base.lazyLoad();base.autoHeight();if(base.options.singleItem===true)base.addActiveClass();if(typeof base.options.afterAction==="function")base.options.afterAction.apply(this)},updateVars:function(){var base=this;base.watchVisibility();base.updateItems();base.calculateAll();base.updatePosition();base.updateControls();
base.eachMoveUpdate()},reload:function(elements){var base=this;setTimeout(function(){base.updateVars()},0)},watchVisibility:function(){var base=this;clearInterval(base.checkVisible);if(!base.$elem.is(":visible")){base.$elem.css({opacity:0});clearInterval(base.autoPlaySpeed)}else return false;base.checkVisible=setInterval(function(){if(base.$elem.is(":visible")){base.reload();base.$elem.animate({opacity:1},200);clearInterval(base.checkVisible)}},500)},wrapItems:function(){var base=this;base.userItems.wrapAll('<div class="owl-wrapper">').wrap('<div class="owl-item"></div>');
base.$elem.find(".owl-wrapper").wrap('<div class="owl-wrapper-outer">');base.wrapperOuter=base.$elem.find(".owl-wrapper-outer");base.$elem.css("display","block")},baseClass:function(){var base=this;var hasBaseClass=base.$elem.hasClass(base.options.baseClass);var hasThemeClass=base.$elem.hasClass(base.options.theme);if(!hasBaseClass)base.$elem.addClass(base.options.baseClass);if(!hasThemeClass)base.$elem.addClass(base.options.theme)},updateItems:function(){var base=this;if(base.options.responsive===
false)return false;if(base.options.singleItem===true){base.options.items=base.orignalItems=1;base.options.itemsDesktop=false;base.options.itemsDesktopSmall=false;base.options.itemsTablet=false;base.options.itemsMobile=false;return false}var width=$(window).width();if(width>(base.options.itemsDesktop[0]||base.orignalItems))base.options.items=base.orignalItems;if(width<=base.options.itemsDesktop[0]&&base.options.itemsDesktop!==false)base.options.items=base.options.itemsDesktop[1];if(width<=base.options.itemsDesktopSmall[0]&&
base.options.itemsDesktopSmall!==false)base.options.items=base.options.itemsDesktopSmall[1];if(width<=base.options.itemsTablet[0]&&base.options.itemsTablet!==false)base.options.items=base.options.itemsTablet[1];if(width<=base.options.itemsMobile[0]&&base.options.itemsMobile!==false)base.options.items=base.options.itemsMobile[1];if(base.options.items>base.itemsAmount)base.options.items=base.itemsAmount},response:function(){var base=this,smallDelay;if(base.options.responsive!==true)return false;$(window).resize(function(){if(base.options.autoPlay!==
false)clearInterval(base.autoPlaySpeed);clearTimeout(smallDelay);smallDelay=setTimeout(function(){base.updateVars()},base.options.responsiveRefreshRate)})},updatePosition:function(){var base=this;if(base.support3d===true)if(base.positionsInArray[base.currentSlide]>base.maximumPixels)base.transition3d(base.positionsInArray[base.currentSlide]);else{base.transition3d(0);base.currentSlide=0}else if(base.positionsInArray[base.currentSlide]>base.maximumPixels)base.css2slide(base.positionsInArray[base.currentSlide]);
...
base.itemWidth;base.owlWrapper.css({"width":width*2,"left":0});base.appendItemsSizes()},calculateAll:function(){var base=this;base.calculateWidth();base.appendWrapperSizes();base.loops();base.max()},calculateWidth:function(){var base=this;base.itemWidth=Math.round(base.$elem.width()/base.options.items)},max:function(){var base=this;base.maximumSlide=base.itemsAmount-base.options.items;var maximum=base.itemsAmount*base.itemWidth-base.options.items*base.itemWidth;maximum=maximum*-1;base.maximumPixels=
maximum;return maximum},min:function(){return 0},loops:function(){var base=this;base.positionsInArray=[0];var elWidth=0;for(var i=0;i<base.itemsAmount;i++){elWidth+=base.itemWidth;base.positionsInArray.push(-elWidth)}},buildControls:function(){var base=this;if(base.options.navigation===true||base.options.pagination===true)base.owlControls=$('<div class="owl-controls"/>').toggleClass("clickable",!base.isTouch).appendTo(base.$elem);if(base.options.pagination===true)base.buildPagination();if(base.options.navigation===
true)base.buildButtons()},buildButtons:function(){var base=this;var buttonsWrapper=$('<div class="owl-buttons"/>');base.owlControls.append(buttonsWrapper);base.buttonPrev=$("<div/>",{"class":"owl-prev","html":base.options.navigationText[0]||""});base.buttonNext=$("<div/>",{"class":"owl-next","html":base.options.navigationText[1]||""});buttonsWrapper.append(base.buttonPrev).append(base.buttonNext);buttonsWrapper.on(base.getEvent(),'div[class^="owl"]',function(event){event.preventDefault();if($(this).hasClass("owl-next"))base.next();
else base.prev()})},getEvent:function(){var base=this;if(base.isTouch===true)return"touchend.owlControls";else return"click.owlControls"},buildPagination:function(){var base=this;base.paginationWrapper=$('<div class="owl-pagination"/>');base.owlControls.append(base.paginationWrapper);base.paginationWrapper.on(base.getEvent(),".owl-page",function(event){event.preventDefault();if(Number($(this).data("owl-page"))!==base.currentSlide)base.goTo(Number($(this).data("owl-page")),true)})},updatePagination:function(){var base=
...
true?"owl-numbers":""});paginationButton.append(paginationButtonInner);paginationButton.data("owl-page",lastPage===i?lastItem:i);paginationButton.data("owl-roundPages",counter);base.paginationWrapper.append(paginationButton)}base.checkPagination()},checkPagination:function(){var base=this;base.paginationWrapper.find(".owl-page").each(function(i,v){if($(this).data("owl-roundPages")===$(base.owlItems[base.currentSlide]).data("owl-roundPages")){base.paginationWrapper.find(".owl-page").removeClass("active");
$(this).addClass("active")}})},checkNavigation:function(){var base=this;if(base.options.navigation===false)return false;if(base.options.goToFirstNav===false)if(base.currentSlide===0&&base.maximumSlide===0){base.buttonPrev.addClass("disabled");base.buttonNext.addClass("disabled")}else if(base.currentSlide===0&&base.maximumSlide!==0){base.buttonPrev.addClass("disabled");base.buttonNext.removeClass("disabled")}else if(base.currentSlide===base.maximumSlide){base.buttonPrev.removeClass("disabled");base.buttonNext.addClass("disabled")}else if(base.currentSlide!==
